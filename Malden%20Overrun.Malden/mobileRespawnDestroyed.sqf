...
/*
	[mobileRespawn,ArsenalItems,false,false] call BIS_fnc_addVirtualItemCargo;
	[mobileRespawn,ArsenalBackpacks,false,false] call BIS_fnc_addVirtualBackpackCargo;
	[mobileRespawn,ArsenalWeapons,false,false] call BIS_fnc_addVirtualWeaponCargo;
	[mobileRespawn,ArsenalMagazines,false,false] call BIS_fnc_addVirtualMagazineCargo;
*/	
